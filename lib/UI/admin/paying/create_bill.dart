                    ...
                    children: [
                      Expanded(
                        child: CustomDropdown(
                          ...
                          onChanged: (value) =>
                              setState(() => selectedInternet = value),
                        ),
                      ),
                      SizedBox(width: 10),
                      Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [Text("Tiền thuê phòng:"), Text("0đ")],
                  ),
                  SizedBox(height: 8),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [Text("Tiền điện:"), Text("0đ")],
                  ),
                  SizedBox(height: 8),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [Text("Tiền nước:"), Text("0đ")],
                  ),
                  SizedBox(height: 8),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [Text("Internet:"), Text("0đ")],
                  ),
                  SizedBox(height: 8),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [Text("Rác:"), Text("0đ")],
                  ),
                  SizedBox(height: 8),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [Text("Gửi xe (0 xe):"), Text("0đ")],
                  ),
                  SizedBox(height: 8),
                  Divider(height: 16),
                  Text(
